        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayForClients = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedToDelete = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleTr = table.Column<string>(nullable: false),
                    DescriptionAr = table.Column<string>(nullable: true),
                    DescriptionEn = table.Column<string>(nullable: true),
                    DescriptionTr = table.Column<string>(nullable: false),
                    CoverPhotoPath = table.Column<string>(nullable: true)
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, null, "Müdür" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "DisplayForClients", "Email", "FullName", "Password", "UserRoleId" },
                values: new object[] { 1, false, "yazanalkhatib956@gmail.com", "Yazan ALKHATIB", "7B0j2NHlveB8q/K6/4abkw==", 1 });
